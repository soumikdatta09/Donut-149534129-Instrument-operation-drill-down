...
import { UtilizationService } from './resourcesTracker/utilization/utilization.service';
...
@NgModule({
    ...
    providers: [AuthGuard, LoginService, LotsService, LocalizationConfig, CampaignService, ManufacturingUnitService,
        SourceService, BlastViewService, InstrumentTypesService, ProjectCampaignService, UtilizationService,
        {
